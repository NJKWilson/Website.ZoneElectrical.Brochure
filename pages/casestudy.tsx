...
const stats = [
  { label: 'Customer', value: 'Morgan Sindall' },
  { label: 'Project Value', value: '£5,000,000' },
  { label: 'Start Date', value: '25/08/2021' },
  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:title" content="Case Studies" key="title" />
      </Head>
